...
const ChatContextProvider: React.FC = ({ children }) => {
   ...
   const { createChannel, joinChannel } = channelsApi;
   ...
   useEffect(() => {
      ...
      loadMessages();
   }, [selectedChannel, socket, isLoading]);
   ...
   const handleSetChannels = (values: any[]): void => {
      setChannelsData(convertApiChannelArrayToChannel(values));
   };
